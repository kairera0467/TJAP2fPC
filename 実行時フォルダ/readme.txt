...
・201708--00から2人プレイが出来るようになりました。(ベータ版)
　・本家っぽい表示には対応していません。
...
・拡張性に欠けてます。
　・特に2016081500に追加した画像は拡張性0です。そのうち改善します。
・手つなぎ音符の見た目が雑です
...
　・そのため上で書いたとおり、COURSE:5は対応していません。
...
スキン配布は、できるだけデフォルトスキンの差分みたいな形での配布にしていただけるとありがたいです。
