...
//Trace.TraceInformation( "SKIN変更BoxDef  : "+  CSkin.strBoxDefSkinSubfolderFullName );
		...
		public void t難易度レベルをひとつ進める()
		{
			...
			for( int i = this.n現在の選択行 - panelcount_half; i < ( ( this.n現在の選択行 - panelcount_half ) + panelcount ); i++ )
			{
		...
		public override int On進行描画()
		{
			...
			if( this.b初めての進行描画 )
			{
                ...
                this.ct譜面分岐文字アニメ.t開始( 1, 200, 10, CDTXMania.Timer );
